...
namespace FTN {
    ...
    public class SwitchingOperation : IdentifiedObject {
        ...
        private List<Switch> cim_Switches = new List<Switch>();
        
        private const bool isSwitchesMandatory = false;
        
        private const string _SwitchesPrefix = "cim";
        ...
        public virtual List<Switch> Switches {
            get {
                return this.cim_Switches;
            }
            set {
                this.cim_Switches = value;
            }
        }
        
        public virtual bool SwitchesHasValue {
            get {
                return this.cim_Switches != null;
            }
        }
        
        public static bool IsSwitchesMandatory {
            get {
                return isSwitchesMandatory;
            }
        }
        
        public static string SwitchesPrefix {
            get {
                return _SwitchesPrefix;
            }
        }
    }
}
